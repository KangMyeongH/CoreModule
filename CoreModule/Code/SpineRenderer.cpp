...
{
    return new SpineRenderer(*this);
}

void GameEngine::SpineRenderer::to_json(nlohmann::ordered_json& _j)
{
...
void GameEngine::SpineRenderer::from_json(const nlohmann::ordered_json& _j)
{
